...
class AnaisLogger
{
    ...
    private static readonly string[] STR_LOG_CATEGORY = { "LAMBERT_SOLVER", "HOHMANN_TRANSFER", "ORBIT", "VELOCITY_ARROW", "MAP_NAVIGATION", "CLOSEST_APPROACH", "EJECTION_TRAJECTORY", "NUMERICAL_MINI_CALCULATOR", "ANAIS_TRANSFER", "ANAIS_TRANSFER_CALCULATOR", "ANAIS_MANAGER" };
